...
namespace Traveler.Behaviours
{
    public class MapBehavior : BindableBehaviour<Map>
    {

        public static readonly BindableProperty ItemsSourceProperty =
            BindableProperty.Create("ItemsSource", typeof(IEnumerable<ILocationViewModel>), typeof(MapBehavior), default(IEnumerable<ILocationViewModel>), propertyChanged: ItemsSourceChanged);
